...
public class SymulatorWycieczki{
    ...
    Set <SluchaczPostepow> listaSluchaczy = new HashSet<SluchaczPostepow>();

    public void dodajSluchacza(SluchaczPostepow sluchacz) {
        listaSluchaczy.add(sluchacz);
    }

    public void dodajSluchacza2(){
        listaSluchaczy.add(klasaAnonimowa());
    }
    ...
    public SluchaczPostepow klasaAnonimowa()
    {
        return new SluchaczPostepow() {
            ...
            {
                System.out.println("KlasaAnonimowa obsługuje element wycieczki "
                        +elementWycieczki.getNazwa());
            }
        };
    }
    ...
    public void symuluj() {
        ...
        for(pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            if(elementWycieczki instanceof Atrakcja) {
                ...
                double czas=atrakcja.getDlugoscZwiedzania();
            ...
            {
                sl.aktualizujPostep(elementWycieczki, pozycjaGrupy+1, wycieczka.getLiczbaElementowWycieczki());
            }
